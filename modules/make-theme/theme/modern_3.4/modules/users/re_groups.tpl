<!-- BEGIN: main -->
<div class="page-header"><h3>{LANG.in_group}</h3></div>
...
<form id="registerForm" action="{USER_REGISTER}" method="post" class="box-border-shadow content-box clearfix reg">
	<dl class="clearfix gray">
		...
		<dd class="fr" style="width:60%"><!-- BEGIN: list --> <input type="checkbox" value="{GROUP.id}" name="group[]" {GROUP.checked} /> <span>{GROUP.title}</span><br />
		<!-- END: list --></dd>
	</dl>
