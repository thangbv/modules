            ...
            <form id="fcontact" method="post" action="{ACTION_FILE}" onsubmit="return sendcontact('{NV_GFX_NUM}');">
                <div class="contact-form box-border content-box">
                    ...
                    <p class="rows">
                        {LANG.content}:
                        <br/>
                        <textarea cols="4" rows="3" id="fcon" name="fcon" onkeyup="return nv_ismaxlength(this, 1000);">{CONTENT.fcon}</textarea>
                    </p>
                    <p class="rows">
                        &nbsp;{LANG.captcha}:&nbsp;<img height="22" src="{NV_BASE_SITEURL}index.php?scaptcha=captcha" title="{LANG.captcha}" alt="{LANG.captcha}" id="vimg" />
