...
<form id="uploadForm" name="uploadForm" action="{FORM_ACTION}" method="post" class="box-border content-box bgray" enctype="multipart/form-data">
    <div class="content-box upload-form box-border m-bottom">
        ...
        <dl class="clearfix">
            ...
            <dd class="fl">
                <textarea class="input" name="upload_linkdirect" id="upload_linkdirect_iavim">{UPLOAD.linkdirect}</textarea>
            </dd>
        </dl>
        <dl class="clearfix">
            <dt class="fl">
        ...
        <dl class="clearfix">
            ...
            <dd class="fl">
                <textarea class="input" name="upload_introtext" id="upload_introtext">{UPLOAD.introtext}</textarea>
            </dd>
        </dl>
        <dl class="clearfix">
            <dt class="fl">
            ...
            <dd class="fl">
                <textarea class="input" name="upload_description" id="upload_description">{UPLOAD.description}</textarea>
            </dd>
        </dl>
        <br />
        <dl class="clearfix">
